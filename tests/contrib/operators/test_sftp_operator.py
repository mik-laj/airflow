...
class SFTPOperatorTest(unittest.TestCase):
    def setUp(self):
        ...
        self.test_local_filepath = '{}/{}'.format(self.test_dir,
                                                    self.test_local_filename)
        # Local Filepath with Intermediate Directory
        self.test_local_filepath_int_dir = '{}/{}'.format(self.test_local_dir,
                                                            self.test_local_filename)
        self.test_remote_filepath = '{}/{}'.format(self.test_dir,
                                                     self.test_remote_filename)
        # Remote Filepath with Intermediate Directory
        self.test_remote_filepath_int_dir = '{}/{}'.format(self.test_remote_dir,
                                                             self.test_remote_filename)
